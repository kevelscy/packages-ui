...
const SheetPortal = (_a) => {
    ...
    return (React.createElement(SheetPrimitive.Portal, Object.assign({ className: cn(className) }, props),
...
const SheetOverlay = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SheetPrimitive.Overlay, Object.assign({ className: cn('fixed inset-0 z-50 bg-background/80 backdrop-blur-sm transition-all duration-100 data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in', className) }, props, { ref: ref })));
});
...
const SheetContent = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SheetPortal, { position: position },
        ...
        React.createElement(SheetPrimitive.Content, Object.assign({ ref: ref, className: cn(sheetVariants({ position, size }), className) }, props),
            children,
